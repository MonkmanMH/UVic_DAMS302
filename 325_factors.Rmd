...
h_countries <- c("Denmark", "Albania", "Mexico", "Spain")  # see what I did there?
...
For example, our short country list would be more entertaining if it spelled out "DAMS".
...
h_gap$country |>
  fct_relevel("Denmark", "Albania", "Mexico", "Spain") |> 
  levels()
...
In this example, we will plot the four countries in our DAMS group by life expectancy.
...
Now it's your turn: plot the four countries in our DAMS group by life expectancy.
...
[Factors and Plotting](https://monkmanmh.shinyapps.io/BIDA_3_3_factor_plot/#section-factors)
