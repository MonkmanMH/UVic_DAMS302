...
subtitle: "UVic DAMS302: Course Book"
...
links-as-notes: true
colorlinks: true
cover-image: "DAMS302_hex_400_sq.png"
url: "https://bookdown.org/martin_monkman/DataAnalyticsCodingFundamentals/"
github-repo: "MonkmanMH/UVic_DAMS302"
description: "The course book for DAMS302"
---
...
# package-a-rama
#
# all of the packages for all the modules of DAMS302
...
<img src="DAMS302_hex_400_sq.png" width="350" height="350" alt="DAMS302 hex" />

_Latest update: `r Sys.Date()`_


This book is based on the lessons for DAMS302, "Data Analytics Coding Fundamentals", offered at the University of Victoria's [Continuing Studies Department](https://continuingstudies.uvic.ca/).

Note that the course was previously part of the Business Intelligence & Data Analytics series, numbered BIDA302.
...
### Some advice from people who took DAMS302/BIDA302 before... {-}

People who have previously taken this course were asked “Imagine that
time travel is possible…You have just been transported back in time
...
your past self about this course?” Here are some of their answers:
  ...
  - Need to spend more time studying since 1-2 hours a week outside class won’t be enough for a dinosaur like
    me.
...
The course book's layout is in 6 sections, each corresponding to the 6 units of the course. Each unit has multiple chapters, corresponding with the topics covered and (when appropriate) the assignment for that unit.
...
The authors would like to acknowledge everyone who has contributed to the books, articles, blog posts, and R packages cited within. And of course, all of the participants in DAMS302 who have asked great questions and helped us get better at explaining the why and what of data analysis using R.
...
The source code for this ebook can be found at this github repository: https://github.com/MonkmanMH/UVic_DAMS302 
