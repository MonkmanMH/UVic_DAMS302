...
The capstone project will be introduced in Unit 4.



Some projects will be available for you to choose, and are described in the chapters that follow.

You may also bring your own data. Talk to the instructor to ensure that your project goals are suitable; past experience has indicated that "projects from home" are likely to be more than is required for this course! We can work to ensure that the scope is feasible for the time available, and will set you up for further development (beyond what is required for the course) if you want to continue.
...
For an example of what your documentation might look like, refer to the chapter from Unit 1, [An example of a data analytics project](#walkthrough).
