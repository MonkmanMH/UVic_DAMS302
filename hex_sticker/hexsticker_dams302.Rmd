...
#    panel.border = element_rect(colour="white"),
    ...
    axis.text = element_text(size=24, colour = "white"),
    axis.ticks = element_line(colour = "white"),
    axis.title = element_text(size=24, colour = "white")
  ) +
  coord_equal() +
  expand_limits(x = c(0, 10), y = c(0, 10))
...
DAMS302_hex <- 
  sticker(subplot = p, package="DAMS302", 
          s_x=0.90, s_y=.75, s_width=1.8, s_height=1.1,
...
ggplot2::ggsave("DAMS302_hex_2.png", width = 2.8, height = 2.8)
