...
In the new chunk you have just created, type the function `say()` (which is from the {cowsay} package), inside the parentheses put a short quote (for example, "I like DAMS302"), and then run the chunk...
