...
1. The hashtag #rstats provides a steady stream of questions and answers, links to new packages, and other news on a variety of social media platforms, including [Bluesky](https://bsky.app/search?q=%23rstats). 
...
Of course, [the other core courses in the Data Analytics for Management Science diploma at UVic](https://continuingstudies.uvic.ca/data-computing-and-technology/programs/data-analytics-for-management-science)!

* DAMS 301 Business Intelligence and Data Analytics Fundamentals

* DAMS 404 Data Visualization and Reporting

* DAMS 405 Data Analytics Provisioning, Importing, Extracting and Manipulation 

* DAMS 406 Predictive Data Analytics and Modelling
