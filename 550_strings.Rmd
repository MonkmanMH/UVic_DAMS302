...
In the Unit 3 assignment, you probably noticed that some of the community names have a pair of asterisks at the end, indicating that the community includes more than one municipality. For example, "North Vancouver" includes both the City of North Vancouver and the District of North Vancouver (two distinct towns, with the same name...) 
